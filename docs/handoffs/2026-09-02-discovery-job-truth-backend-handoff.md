...
> **状态复核（2026-09-04 18:44 +08:00）：已完成。** Discovery eligibility、确认过的结构化岗位事实、MatchCase 重检与公开合同已由集成提交 `37661dee9` 落地，并已确认是后端 `origin/release/0.2.5@21e34ff04` 的祖先。后文仅保留为历史设计与验收记录。
