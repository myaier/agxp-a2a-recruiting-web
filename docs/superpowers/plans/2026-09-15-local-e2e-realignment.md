...
|数据源模式.spec.ts:7899,8374,8412,8479,8550,9029,9152,9199,9252,9291,9430,9658,9772,10102,10189,10720,11653,12911,12966,13065,13142,13433|22|共享档案阻断的角色切换／发现／Case／会话等|2；后续相应 Task|Task 2 已实施 2026-09-15：21/22 完整通过（P6 7899；P4 8374/8412/8479/8550；P5 9029/9152/9199/9252/9291/9430；在谈 9658/9772；P7 10102/10189；P8 10720；卡片 12911/12966/13065/13142；S0 13433）；11653 水合已恢复但卡名片旧「公司」自由输入（`getByLabel('公司')` 已不存在，公司改选择控件），归 Task 3（其选集含「核心编辑 岗位」）。Task 3 已实施 2026-09-15：11653 入口改应用内名片（注册流入口被已完成账号守卫弹回主壳），公司经 公司选择抽屉 选中后保存，再进发岗向导（档案 organization_ref 按 ID 读回的默认行）；POST body 断言补 direct 双 ref=组织甲编号；其余 21 条不受本次共享输入改动影响，attempt-5/6 仍完整通过。Task 6 已实施 2026-09-15：Task 3–5 对共享文件再变更（experiences handler 对齐合同 C、educations PATCH/GET intentions 新路由、`断言经历写入` 键集收紧）后，本组除 11653（Task 3 run-5 已验）外的 21 条按 Task 2 记录原选集补验：consumer-repair-1 21/21；同任务把本文件 11 处静默失效的 `test.use({timeout})` 死行改为 describe 级 `beforeEach(() => test.setTimeout(原值))`（逐值恢复 60/90/120/150/180s 声明预算，不抬不降；120s 各行与配置缺省同值，实际只影响 60/90/150/180s 组）后重算：consumer-repair-2 21/21、受预算变化影响的其余 18 条（Backend 数据源 fixture 9、P6 3、在谈 Mock 双端 2、标注 2、J-PILOT-01 场景一/二）consumer-repair-3 三项目 18/18|
