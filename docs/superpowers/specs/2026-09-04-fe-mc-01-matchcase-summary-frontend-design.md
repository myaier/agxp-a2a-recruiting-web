...
候选与招聘两端“代理详情”页现有的“正在代谈”数字也已复用同一个 P5 open 统计 selector；它们只消费已在内存中的当前角色 summary，不额外注册 scope 或发请求，直达且未加载时继续显示 `—`。现有“正在代谈”标题不变。
...
src/屏幕/代理详情.tsx
src/屏幕/代理详情.test.tsx
src/屏幕/企业代理详情.tsx
src/屏幕/企业代理详情.test.tsx
```
