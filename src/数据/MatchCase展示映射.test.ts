...
describe('映射P5详情：S0 结果语义', () => {
  ...
  const S0结果用例: {
    ...
    { 名: 'ended at S0 + policy_rejected → 未通过（A.2.1 全字典：终局段不再只认 S0 两词）', 区状态: 'ended', 区摘要: 'complete',
      根: 造S0终局根('policy_rejected'), 提供: [], 期望动作: [], 期望文案: '未通过' },
    { 名: 'ended at S0 + semantic_not_fit → 不匹配', 区状态: 'ended', 区摘要: 'complete',
      根: 造S0终局根('semantic_not_fit'), 提供: [], 期望动作: [], 期望文案: '不匹配' },
    { 名: 'ended at S0 + semantic_uncertain_stop → 信息不足', 区状态: 'ended', 区摘要: 'complete',
      根: 造S0终局根('semantic_uncertain_stop'), 提供: [], 期望动作: [], 期望文案: '信息不足' },
    { 名: 'ended at S0 + agent_failed → 筛选未完成（技术失败不推不匹配）', 区状态: 'ended', 区摘要: 'complete',
      根: 造S0终局根('agent_failed'), 提供: [], 期望动作: [], 期望文案: '筛选未完成' },
