...
const 简历经历初始: 简历经历段[] = [
  {
    ...
    // 契约B（2026-09-17）：Mock 种子补组织编号 —— 经历企业屏蔽开关/徽标与隐私页的
    // 同组织同步在 Mock 演示里也有可观察坐标（hidden 原值保留，不再由屏蔽 UI 读写）
    组织编号: 'mock_org_bytedance',
  },
  {
    编号: 'e2', 公司: '美团', 行业: '互联网', 职位: '后端开发工程师', 开始: '2017-07', 结束: '2019-05',
    内容: '交易履约链路开发，负责订单状态机与超时补偿模块\n参与订单中心从单体到微服务拆分，发布周期从双周缩短到每日\n搭建链路压测平台，支撑三次大促容量评估', 隐藏: false,
    组织编号: 'mock_org_meituan',
  },
];
// Task 4：默认 Mock 教育固定为 2014/2017（真实资料）；演示种子
//（就读年份演示预填 2021/2025）仅由显式种子场景消费，不在此展开
const 简历教育初始: 简历教育段[] = [{
  编号: 'edu1', 学校: '上海交通大学', 学历: '硕士', 专业: '计算机科学', 开始: '2014-09', 结束: '2017-06',
}];
