...
// 类名形如「模块文件-module__类名__ab3d」（vite.config 里配的 generateScopedName），
// 从中能直接反查到定义文件与类（如 .薪资 在 src/组件/列表卡片/求职在谈卡.module.css，
// 2026-09-10 卡片统一后卡面样式都在 组件/列表卡片/ 下）—— 所以收到标注的人
