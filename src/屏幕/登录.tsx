...
export default function 登录() {
  ...
  return (
    <次级页外壳>
      {/* 上留白：标注 2026-08-24「手机号输入和验证部分太靠上了，往下挪一挪」。
          根子是 08-18 撤掉代理引导气泡后，剩余高度全被下面的 留白区(flex:1) 占走，
          整组被顶到天花板。上方加 0.75 份弹性空位，与下方 1 份分掉剩余高度 ——
          取 0.75:1 而不是 1:1，人眼认的「居中」略高于几何中心。 */}
      <div className={样式.上留白} />
      ...
      <div className={样式.品牌区}>
        {/* 2026-08-24 定名「工作蜂」；slogan 由产品负责人选定（「找工作，蜂替你谈」，
            候选五选一）—— 不是自拟文案 */}
        <h1 className={样式.产品名}>工作蜂</h1>
        <p className={样式.主张}>找工作，蜂替你谈</p>
      </div>
