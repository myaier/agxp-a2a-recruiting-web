...
export function S0记录样本(): P5S0筛选记录 {
  return {
    messages: [
      ...
      { id: 's0a_1', kind: 'answer', role: 'recruiter', stage: 'anonymous_screening', askingRole: 'candidate', round: 1, answerStatus: 'answered', answerSource: 'agent', text: '没有固定晚班，周末偶尔需要支援。', exchangeRef: null, occurredAt: '2026-08-23T10:05:00Z' },
      ...
      { id: 's0a_2', kind: 'answer', role: 'recruiter', stage: 'anonymous_screening', askingRole: 'candidate', round: 2, answerStatus: 'declined', answerSource: 'agent', exchangeRef: null, occurredAt: '2026-08-30T09:02:00Z' },
      ...
      { id: 's0a_3', kind: 'answer', role: 'recruiter', stage: 'anonymous_screening', askingRole: 'candidate', round: 3, answerStatus: 'unknown', answerSource: 'agent', exchangeRef: null, occurredAt: '2026-08-30T09:12:00Z' },
      ...
      { id: 's0a_4', kind: 'answer', role: 'recruiter', stage: 'anonymous_screening', askingRole: 'candidate', round: 4, answerStatus: 'not_available', answerSource: 'agent', exchangeRef: null, occurredAt: '2026-08-30T09:22:00Z' },
    ],
    summaries: [
