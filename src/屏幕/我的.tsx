...
// 状态胶囊）→ 四个统计数 → 代理状态毛玻璃卡 → 常用/其他功能宫格 → 页脚小字。
...
export default function 我的() {
  ...
  // J-PILOT-01 Task 4：候选统计格改用已开案口径的标签（数值仍是 /match-cases summary 的
  // Case 数，不新增请求、不改布局；「开案待办」入口仍进全意向在谈，不声称全量委托计数）。
  const 统计: 统计格[] = 是后端 ? [
    {
      数值: Backend统计.open,
      名称: '已开案',
    ...
    { 数值: Backend统计.archived, 名称: '开案归档', 色: '次要' },
  ] : 原Mock统计;
  ...
  return (
    <主页外壳 白底>
      ...
      {/* ── 头像行：整行可点，进「个人信息」（账号身份:头像/姓名/联系方式）。
