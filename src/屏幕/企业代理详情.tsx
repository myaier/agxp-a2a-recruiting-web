...
const 权限边界 = [
  ...
  },
  {
    ...
    记: '!',
    类: '要问',
    条目: ['超出规则范围的让步', '确认意向（互换联系方式前）', '任何要动岗位硬性条件的判断'],
  },
  {
    组: '它永远不做',
    记: '×',
    类: '不做',
    条目: [
      '把岗位薪资带的上限告诉对方（只答是否落在候选人期望内）',
      '把你的用人底线当筹码抛出去',
      '替你谈薪资与到岗时间 —— 那是你和候选人自己谈的',
    ],
  },
];
