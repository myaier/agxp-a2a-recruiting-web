...
import { 信封, 目录页, 断言精确键集, 取multipart部件, 解metadata部件, type 拦截请求形 } from './fixtures/bff/协议';
import { 标记, fixture主体, fixture简历, fixture意向列表 } from './fixtures/bff/账号与目录';
import { P6标记, P6编号, P6分支编号, P6规则, candidateGlobalRule, candidateIntentionRule, recruiterGlobalRule, candidateInterpretingProposal, candidateReadyProposal, type P6FixtureState, type P6Proposal, type P6Rule, type P6分支配置, type P6提案元数据形 } from './fixtures/bff/Agent规则';
import { P4编号, P4标记, P4补充编号, P4摘要, P4在线简历, P4深克隆, P4招聘分页, P4非展开卡, P4分页, P4发现批次, P4发现偏好, P4CandidateJob, P4候选卡, P4招聘卡, P4意向, P4招聘岗位, P4发现fixture, type P4发现fixture形, type P4委托回执形, type P4招聘推荐形, type P4淘汰原因形 } from './fixtures/bff/发现推荐';
import { P1C标记, 创建招聘方OnboardingFixture, P1C企业档案, P1C岗位, P1C招聘组织Fixture, P1C管理员关系, P1C成员关系, P1C组织甲, P1C组织乙, 带企业关系, 一像素PNG, P3全未知硬性条件, type P1C企业关系形, type P1C企业媒体形, type P1C企业档案形, type P1C岗位形, type P1C招聘方档案形, type P1C招聘组织Fixture形, type P1C管理员申请形, type P3硬性条件形, type 招聘方OnboardingFixture形 } from './fixtures/bff/招聘组织';
import { P3标记, P3隐私fixture, P3默认组织库, P1C搜索池, P3克隆视图, 创建候选实名fixture, IV要求, type P3屏蔽形, type P3隐私fixture形, type P3隐私形, type 候选实名FixtureState } from './fixtures/bff/隐私与实名';
import { P2限制, P2时间, P2要求, P2新附件, 创建P2附件fixture, type P2附件fixture形 } from './fixtures/bff/附件';
import { P5编号, P5标记, P5状态wire, P5列表项wire, P5递交结果wire, P5详情wire, P5连续编号, P5连续动态, 种连续探针记录, P5连续卡wire, P5连续详情wire, 创建P5MatchCasefixture, type P5Case记录形, type P5MatchCasefixture形, type P5角色词, type P5连续记录形 } from './fixtures/bff/MatchCase';
import { P7会话编号, P7标记, 创建P7fixture, P7会话项wire, type P7FixtureState, type P7消息wire形, type P7角色词 } from './fixtures/bff/真人消息';
import { P8键模式, P8ZIP字节, P8编号, P8标记, 创建P8fixture, type P8FixtureState, type P8凭证wire形, type P8变更回执形 } from './fixtures/bff/账号控制面';
import { Onboarding标记, Onboarding目录展示, 创建候选OnboardingFixture, 断言证书写入, 断言资料写入, 断言摘要写入, 断言技能写入, 断言经历写入, 断言教育写入, 断言意向写入, type 候选OnboardingFixture } from './fixtures/bff/候选建档';
...
async function pickerMock登录(page: Page): Promise<void> {
  await page.goto('/');
  await page.getByText(/已阅读并同意/).click();
  await page.getByRole('button', { name: '微信登录' }).click();
  await expect(page).toHaveURL(/#\/identity$/);
...
async function pickerBackend存量候选(
  page: Page,
  登录尝试id: string,
  隐私覆盖: Partial<P3隐私形> = {},
